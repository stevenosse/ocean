    ...
    <div v-else>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div
          ...
          <div class="px-4 py-5 sm:p-6">
            <div class="flex items-center">
              <div class="flex-shrink-0 bg-gradient-to-r from-blue-500 to-blue-600 rounded-md p-3 shadow-md">
          ...
          <div class="bg-gray-50 px-4 py-4 sm:px-6 border-t border-gray-100">
            <div class="text-sm flex justify-between items-center">
              <NuxtLink to="/projects" class="font-medium text-blue-600 hover:text-blue-500 flex items-center">
                View all projects
        ...
        <div
          ...
          <div class="bg-gray-50 px-4 py-4 sm:px-6 border-t border-gray-100">
            <div class="text-sm flex justify-between items-center">
              <NuxtLink to="/deployments" class="font-medium text-blue-600 hover:text-blue-500 flex items-center">
          ...
          <div v-else class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
              <thead class="bg-gray-50">
                <tr>
                  <th scope="col"
                    class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Project</th>
                  <th scope="col"
      ...
      'bg-red-100 text-red-800': deployment.status === 'failed'
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    <span class="font-mono bg-gray-100 px-2 py-1 rounded">{{ deployment.commitHash.substring(0, 7)
                      }}</span>
                    <div class="mt-1 text-xs text-gray-500 truncate max-w-xs">{{ deployment.commitMessage || 'No commit message' }}</div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
