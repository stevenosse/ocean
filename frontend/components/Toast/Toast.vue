    ...
    <div class="fixed top-4 right-4 z-50 flex flex-col gap-2 w-80">
      <TransitionGroup name="toast">
        <div
          ...
          :key="toast.id"
          :class="[
            'p-4 rounded-md shadow-md flex items-start gap-3 transform transition-all duration-300',
        ...
        >
          <div class="flex-shrink-0">
            ...
            <svg v-else-if="toast.type === 'warning'" class="h-5 w-5 text-yellow-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
